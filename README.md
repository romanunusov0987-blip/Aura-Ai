...
> 🪟 Для пользователей Windows обновлён файл `powershell_launch_guide.txt` — в нём собраны готовые PowerShell-команды для клонирования репозитория, настройки окружения и запуска всех сервисов одной командой.
...
2. Установите зависимости: `pip install -r requirements.txt`.
3. Запустите весь стек одной командой: `python run_all.py`.
4. Или поднимите только основной бот: `python Aura_Psycholog_bot.py` (остальные сервисы можно стартовать отдельно при необходимости).
