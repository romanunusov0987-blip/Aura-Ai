...
### Виртуальное окружение в Windows

Создайте окружение вручную:

1. Откройте PowerShell.
2. Выполните `python -m venv .venv` (при необходимости замените `.venv` на другой путь).
3. Активируйте окружение: `. .venv\Scripts\Activate.ps1`.
4. Установите зависимости: `pip install -r requirements.txt`.

Метод подходит вместо удалённого скрипта `venv.ps1` и работает при наличии установленного Python 3.11+.
